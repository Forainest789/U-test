...
STAGE1_LOW_CKPT_PATH="${STAGE1_LOW_CKPT_PATH:-${REPO_DIR}/ckpt/stage1/stage1_low.pt}"
STAGE1_HIGH_CKPT_PATH="${STAGE1_HIGH_CKPT_PATH:-${REPO_DIR}/ckpt/stage1/stage1_high.pt}"
STAGE2_LOW_CKPT_PATH="${STAGE2_LOW_CKPT_PATH:-${REPO_DIR}/ckpt/stage2/stage2_low.pt}"
STAGE2_HIGH_CKPT_PATH="${STAGE2_HIGH_CKPT_PATH:-${REPO_DIR}/ckpt/stage2/stage2_high.pt}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_DIR}/inference_outputs/slotmem_stage2}"
...
if [[ "${native_wan_enabled}" == "0" && -z "${LOW_EXPERT_CKPT_PATH}" && -z "${HIGH_EXPERT_CKPT_PATH}" ]]; then
  LOW_EXPERT_CKPT_PATH="${STAGE1_LOW_CKPT_PATH},${STAGE2_LOW_CKPT_PATH}"
  HIGH_EXPERT_CKPT_PATH="${STAGE1_HIGH_CKPT_PATH},${STAGE2_HIGH_CKPT_PATH}"
fi
...
if [[ "${native_wan_enabled}" == "0" ]]; then
  check_ckpt_list "HIGH_EXPERT_CKPT_PATH" "${HIGH_EXPERT_CKPT_PATH}"
  check_ckpt_list "LOW_EXPERT_CKPT_PATH" "${LOW_EXPERT_CKPT_PATH}"
fi
