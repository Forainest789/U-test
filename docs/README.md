...
The public SlotMem entry points are documented in the repository-level
`README.md`, `data_curation/README.md`, and the shell launchers:

- `train_slotmem_stage1.sh`
...
for runtime maintenance. Those files are not the SlotMem paper-code
documentation.
